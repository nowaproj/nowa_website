...
export const EventPage = () => {
  const eventLink =
    "https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=MWxlN2pqdXZnZDVuY2E2ZmZhMjMzdW1qYjYgNjAzYTc0YmZlOTIyMzk1Mjk1MWZmY2U1ZDhiY2E3MjY3ZjhlOTI0NzE4YzhkMjU3ZmY4YWQ2YTYxMGFlNTNiMEBn&tmsrc=603a74bfe9223952951ffce5d8bca7267f8e924718c8d257ff8ad6a610ae53b0%40group.calendar.google.com";
    ...
    <>
      ...
      <main>
        <div className="event-header mara mw">
          ...
          {isMobile() || isTablet() ? (
            <a
              href={`https://nowa.dev/Public_EventsNowa.ics`}
              target="_blank"
              onClick={() => {
                ReactGA.event({
                  action: "clicked event link",
